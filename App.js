      ...
      screens: {
        ...
        Admin: {
          ...
          screens: {
            ...
            AdmissionDetail: {
              path: 'detail',
              stringify: { admission: (a) => encodeURIComponent(JSON.stringify(a)) },
              parse: { admission: (a) => { try { return JSON.parse(decodeURIComponent(a)); } catch { return null; } } },
            },
            Students: {
              path: 'students',
              stringify: { admission: (a) => a ? encodeURIComponent(JSON.stringify(a)) : '' },
              parse: { admission: (a) => { try { return JSON.parse(decodeURIComponent(a)); } catch { return null; } } },
            },
            Criteria: {
              path: 'criteria',
